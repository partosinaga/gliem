...
<!--MODAL CONFIRMATION REPOST-->
      <div id="static2" class="modal fade" tabindex="-1" data-backdrop="static"
          ...
          <div class="modal-footer">
                  <a>
                      <button type="button" class="btn btn-success" name="yes"><i class="fa fa-check"></i> Yes</button>
                  </a>

                  <a>
                      <button type="button" data-dismiss="modal" form="form1" class="btn btn-danger"><i
                              class="fa fa-remove"></i> Cancel
                      </button>
                  </a>

                  <a>
                      <button type="submit" class="btn btn-success" name="no"><i class="fa fa-check"></i> No</button>
                  </a>
